...
%\centering
%
%\begin{tabular}{|p{1cm} *{8}{|p{1cm}} | p{1cm} |}
%    \hline
%    Relay & Sensor &
%    Mobility Type &  Avg. (sec) & \textless 2 min (\%) & PDR (\%) \\
%    \hline
%
%\end{tabular}
%
...
%\centering
%
%\begin{tabular}{|p{1.2cm} *{8}{|p{1.2cm}} | p{1.2cm} |}
%    \hline
%    \multirow{2}{*}{\parbox{4cm}{Number of Sensor Nodes}} &
%    \multirow{2}{*}{Mobility Type} &  Avg. (sec) & \textless 2 min (\%) &
%    \multirow{2}{*}{PDR (\%)} \\
%    \hline
%
%\end{tabular}
