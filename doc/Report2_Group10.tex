...
that matches our mobility requirements: Reference Point Group Mobility model (RPGM) 
...
we found it to simulates the cows’ behaviour more precisely than RPGM.
...
\begin{itemize}
    ...
    \item 2 different configurations of the nomadic mobility model one with
        the parameters: 
        ;
