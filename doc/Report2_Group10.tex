...
which is java application that can create and analyze many different mobility 
...
(Figure 1) where sensor nodes are moving in groups uniformly and Nomadic Community 
Mobility model (Figure 2) where sensor nodes move in groups but some nodes can also 
