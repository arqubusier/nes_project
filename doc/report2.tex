...
between 38.3 and 38.9 $^\circ$C~\cite{wikibov} and one could limiting the
...
contiki nodes. This simulator is compatible with the following platforms: TI
MSP430x,  TI MSP430x, Atmel AVR, micaz, TI MSP430, TI MSP430 and Native
...
of each other and has single and multi-hop broadcast(11).
...
datarate, of around 40 kbp/s \cite{ieee802154}, it is
