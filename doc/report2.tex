...
In fact, it generates some € 8.6 billion every year in the Netherlands alone~\cite{nedgov}. At the same time, there is a clear trend of automatization in
...
\cite{ieee_computersocietyieee2011} will be used.  For the network- and
...
datarate, of around 40 kbp/s \cite{ieeecomputersocietyieee2011}, it is
...
cc2420\_set\_txpower(desired\_power\_level), where desired\_power\_level could be any
...
not the goal of this project~\cite{contiktdev}.
...
transmission range will differ~\cite{contiktdev}.
...
\bibitem{ieeecomputersocietyieee2011}
