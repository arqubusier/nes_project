...
The network topology will have a tree like structure with the base station
acting as the root of the tree, see Fig \ref{fig:topology}. The relay nodes
will act as the branches of the tree, being connected to the base station
through each other, while the sensor nodes will behave like the leaves of the
tree. Using this setup, the sensor nodes will be configured as reduced
functioning devices (RFDs) and the other nodes will be full functioning devices
(FFDs).
